...
import os
from service.searchService import getPlacesFromWeb, getUrlsFromWeb  # 通过外部搜索得到资料的urls和松江大学城的places
from service.searchService import getAroud_smallplace_On_bigPlace
from service.ImageService import getTraitsFrom_Images, getTraitsFrom_Image  # 业务实现类：得到图像特征
from compute.compute_similarity import calculate_embedding_cosine_similarity, \
...
import tempfile
import json
from utils.similarity_read import write_top_similarities_to_file  # 将相似度top-3的信息写入文件
from model.modeljudge import judge_byModel  # 进行特征的最后决策
from utils.process_set_tolist import convert_sets_to_lists  # 将set数据转为list数据
from tts.text_to_video import generate_audio  # 根据文本生成音频
...
def upload_file():
    ...
    first_question = "南昌市xxxx区xxx大学城内有哪些建筑物？"
    ...
    return jsonify({
        ...
        "urls_from_web": convert_sets_to_lists(urls_from_web),
